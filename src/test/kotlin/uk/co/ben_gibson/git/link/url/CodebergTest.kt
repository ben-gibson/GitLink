...
import uk.co.ben_gibson.git.link.platform.Codeberg
...
class CodebergTest {
    ...
    companion object {
        private val BASE_URL = URL.fromString("https://codeberg.org/my/repo")
        ...
        fun urlExpectations(): Stream<Arguments> = Stream.of(
            ...
            Arguments.of(
                ...
                "https://codeberg.org/my/repo/src/branch/master/src/foo%20bar%20baz/images/my-image.png",
    ...
    fun `should generate correct URLs`(
        ...
        // Given
        val factory = TemplatedUrlFactory(Codeberg().templates)
