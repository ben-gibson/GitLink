...
class SourceHutTest {
    ...
    companion object {
        ...
        fun urlExpectations(): Stream<Arguments> = Stream.of(
            Arguments.of(
                BASE_URL,
                UrlOptions.FileAtBranch(FILE_RUST, BRANCH_MAIN, LINE_SELECTION_SMALL),
            ...
            Arguments.of(
                BASE_URL,
                UrlOptions.FileAtBranch(FILE_RUST, BRANCH_MAIN, null),
                "https://git.sr.ht/~myuser/myproject/tree/main/item/src/main.rs",
                "File at branch without line selection"
            ),
            Arguments.of(
                BASE_URL,
                UrlOptions.FileAtCommit(FILE_RUST, "main", COMMIT_SRHT, LINE_SELECTION_SMALL),
            ...
            Arguments.of(
                BASE_URL,
                UrlOptions.FileAtCommit(FILE_RUST, "main", COMMIT_SRHT, null),
            ...
            Arguments.of(
                BASE_URL,
                UrlOptions.Commit(COMMIT_SRHT, "main"),
