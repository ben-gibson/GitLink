...
class ChromiumTest {
    ...
    companion object {
        ...
        fun urlExpectations(): Stream<Arguments> = Stream.of(
            Arguments.of(
                BASE_URL_CHROMIUMOS,
                UrlOptions.FileAtBranch(FILE_C, BRANCH_MASTER, LINE_SELECTION_RANGE),
            ...
            Arguments.of(
                BASE_URL_CHROMIUMOS,
                UrlOptions.FileAtBranch(FILE_C, BRANCH_MASTER, null),
            ...
            Arguments.of(
                BASE_URL_CHROMIUMOS,
                UrlOptions.FileAtCommit(FILE_C, "main", COMMIT_FULL, LINE_SELECTION_RANGE),
            ...
            Arguments.of(
                BASE_URL_CHROMIUMOS,
                UrlOptions.FileAtCommit(FILE_C, "main", COMMIT_FULL, null),
