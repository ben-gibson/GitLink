...
import uk.co.ben_gibson.git.link.git.GIT_HUB
...
class GitHubTest {
    ...
    companion object {
        ...
        private val REMOTE_BASE_URL = URL("https://github.com/my/repo")
    ...
    fun canGenerateUrl(options: UrlOptions, expectedUrl: String) {
        val url = TemplatedUrlFactory(GIT_HUB.urlTemplate).createUrl(options)
