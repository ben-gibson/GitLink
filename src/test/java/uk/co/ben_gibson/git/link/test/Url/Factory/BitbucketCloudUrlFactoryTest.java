...
{
    public static BitbucketCloudUrlFactory factory()
    {
        return new BitbucketCloudUrlFactory(new URLTemplateProcessor());
    }
        ...
        return new Object[][] {
            {
                ...
                "https://bitbucket.org/foo/bar/src/f7c244eeea9f8e4ebbeabc1500b90e656f5d0328/src/Bar.java#lines-10:10"
            },
            {
                factory(),
                mockRemote("https://bitbucket.org/foo/bar"),
        ...
        return new Object[][] {
            {
                ...
                Branch.master(),
                new LineSelection(10),
                "https://bitbucket.org/foo/bar/src/HEAD/src/Bar.java?at=master#lines-10:10"
            },
            {
                factory(),
                mockRemote("https://bitbucket.org/foo/bar/"),
            ...
            },
            {
                ...
                new Branch("dev"),
                null,
                "http://bitbucket.org/foo/bar/src/HEAD/src/Bar.java?at=dev#lines-0:0"
            },
            {
                factory(),
                ...
                null,
                "https://foo-bar.org/foo%20bar/bar/src/HEAD/src/foo/Foo%20Bar%20Baz.java?at=dev-wip[2.0.0]#lines-0:0"
            },
        };
    }
}
