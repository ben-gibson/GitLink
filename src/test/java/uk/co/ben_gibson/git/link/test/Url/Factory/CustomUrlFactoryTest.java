...
public class CustomUrlFactoryTest extends UrlFactoryTest
{
    public static CustomUrlFactory factory(
        ...
        preferences.customFileUrlOnBranchTemplate = fileAtBranchUrlTemplate;
        preferences.customFileUrlAtCommitTemplate = fileAtCommitUrlTemplate;
        preferences.customCommitUrlTemplate = commitUrlTemplate;

        return new CustomUrlFactory(new URLTemplateProcessor(), preferences);
    }
