...
public class CommitAnnotationAction extends Action implements UpToDateLineNumberListener
{
    private FileAnnotation annotation;
    private int lineNumber = -1;

    public CommitAnnotationAction(@NotNull FileAnnotation annotation)
    {
